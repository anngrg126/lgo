...
#      content_tag(:label, "Confirm new password", for: "user_password_confirmation") +
  ...
  def devise_current_password_field
    ...
    if messages.include? "Current password" 
      content_tag(:label, "Current Password", for: "user_current_password", class: "is-invalid-label") + 
      tag(:input, id: "user_current_password", autocomplete: "off", name: "user[current_password]", type: "password", class: "is-invalid-input form-control") +
      content_tag(:span, "#{messages_array[errormessage]}", class: "form-error is-visible")
    else
#      content_tag(:label, "Current Password", for: "user_current_password") +
      tag(:input, id: "user_current_password", autocomplete: "off", name: "user[current_password]", type: "password", placeholder: "Password", class: "form-control")
    end
  end
end